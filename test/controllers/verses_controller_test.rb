...
class VersesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create verse" do
    assert_difference('Verse.count') do
      post verses_url, params: { verse: { book: @verse.book, chapter: @verse.chapter, verse: @verse.verse, verse_text: @verse.verse_text } }
    end
  ...
  test "should update verse" do
    patch verse_url(@verse), params: { verse: { book: @verse.book, chapter: @verse.chapter, verse: @verse.verse, verse_text: @verse.verse_text } }
